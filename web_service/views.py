...
model_file = os.path.abspath('Model/LSTM_model_glove_300_DATA_without_text_processing.sav')
token_file = os.path.abspath('Model/LSTM_token_glove_300d_DATA_without_text_processing.sav')
