...
token_file = os.path.abspath('web_service/LSTM_token_glove_300d_DATA_wit_text_processing7.sav')
model_file = os.path.abspath('web_service/LSTM_model_glove_300_DATA_with_text_processing_v7.sav')
...
def prediction_request(text):
    try:
       ...
       return HttpResponse(json.dumps({"id":msg["id"],"message":msg["message"],"label":x,"probability":str(probability)}), content_type='application/json')
       K.clear_session()
